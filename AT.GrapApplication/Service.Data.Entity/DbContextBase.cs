...
using Service.Utility.Logging;

using TransactionalBehavior = Service.Core.Data.TransactionalBehavior;
...
using Service.Data.Entity.Properties;

namespace Service.Data.Entity
{
    /// <summary>
    /// 数据库上下文基类
    /// </summary>
